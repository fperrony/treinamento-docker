...
function sendMemcacheCommand($server,$port,$command){
	...
	if (!$s){
		die("Can't connect to:<b>".$server.'</b>:<b>'.$port . "</b> at " . time());
	}
...
<div class=content>
EOB;
    $header .= '<p style="font-style: monospace; font-weight: bolder; font-size: 120%;">'.php_uname('n').$_SERVER['PHP_SELF'].'</p>';
